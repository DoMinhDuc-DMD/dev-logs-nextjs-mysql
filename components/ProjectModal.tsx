...
// export default function ProjectModal({ projectId, memberRole, isOpenModal, handleOK, handleCloseModal }: ProjectModalProps) {
...
//   return (
//     <Modal width={"50%"} title="Điều chỉnh dự án" open={isOpenModal || false} onOk={handleOK(projectId)} onCancel={handleCloseModal}>
